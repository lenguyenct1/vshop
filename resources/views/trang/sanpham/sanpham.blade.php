                            ...
                            <div class="col-md-4">
                                ...
                                <form>
                                    ...
                                    <select name="sort" id="sort" class="form-control">
                                        <option value="{{Request::url()}}?sort_sanpham=none">--Lọc theo--</option>
                                        <option value="{{Request::url()}}?sort_sanpham=tang_dan">--Giá tăng dần--</option>
                                        <option value="{{Request::url()}}?sort_sanpham=giam_dan">--Giá giảm dần--</option>
                                        <option value="{{Request::url()}}?sort_sanpham=kytu_az">--Lọc theo tên A đến Z--</option>
                                        <option value="{{Request::url()}}?sort_sanpham=kytu_za">--Lọc theo tên Z đến A--</option>
