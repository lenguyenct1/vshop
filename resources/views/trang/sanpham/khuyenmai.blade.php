                            ...
                            <div class="col-md-4">
                                ...
                                <form>
                                    ...
                                    <select name="sort" id="sort" class="form-control">
                                        <option value="{{Request::url()}}?sort_khuyenmai=none">--Lọc theo--</option>
                                        <option value="{{Request::url()}}?sort_khuyenmai=tang_dan">--Giá tăng dần--</option>
                                        <option value="{{Request::url()}}?sort_khuyenmai=giam_dan">--Giá giảm dần--</option>
                                        <option value="{{Request::url()}}?sort_khuyenmai=kytu_az">--Lọc theo tên A đến Z--</option>
                                        <option value="{{Request::url()}}?sort_khuyenmai=kytu_za">--Lọc theo tên Z đến A--</option>
...
"><p style="color: white; margin-left: 15px;">Sale</p></div>
                        ...
                        @endforeach
                         @else
                             <div style="font-size: 30px; text-align: center;">Không có sản phẩm khuyến mãi</div>
                             @endif   
                    </div><!--features_items--> 
        <!--/recommended_items-->
      {!!$sp->links()!!}
