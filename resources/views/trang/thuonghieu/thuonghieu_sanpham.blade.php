...
<div class="features_items"><!--features_items-->
                        ...
                        @foreach($th_ten as $key => $ten)
                       
                        <h2 class="title text-center">{{$ten->th_ten}}</h2>
                            ...
                            <div class="col-md-4">
                                ...
                                <form>
                                    ...
                                    <select name="sort" id="sort" class="form-control">
                                        <option value="{{Request::url()}}?sort_thuonghieu=none">--Lọc theo--</option>
                                        <option value="{{Request::url()}}?sort_thuonghieu=tang_dan">--Giá tăng dần--</option>
                                        <option value="{{Request::url()}}?sort_thuonghieu=giam_dan">--Giá giảm dần--</option>
                                        <option value="{{Request::url()}}?sort_thuonghieu=kytu_az">--Lọc theo tên A đến Z--</option>
                                        <option value="{{Request::url()}}?sort_thuonghieu=kytu_za">--Lọc theo tên Z đến A--</option>
...
"><p style="color: white; margin-left: 15px;">Sale</p></div>
                                                ...
                                                @endif
                                            <img width="100px" height="250px" src="upload/sanpham/{{$dssp->sp_hinh}}" alt="" />@if($date>=$dssp->khuyenmai_ngaybatdau && $date<=$dssp->khuyenmai_ngayketthuc)
