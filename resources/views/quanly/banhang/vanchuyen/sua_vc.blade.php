                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                <form role="form" action="{{URL::to('/banhang/sua-vc/'.$vc->vc_id)}}" method="post">
                                    {{ csrf_field() }}
                                   
                              
                               <div class="form-group">
                                    <label for="exampleInputEmail1">Tên hình thức vận chuyển </label>
                                    <input type="text" name="vc_ten" class="form-control" id="exampleInputEmail1" placeholder="Tên vận chuyển" data-validation="length" data-validation-length="min5"  data-validation-error-msg="Làm ơn điền ít nhất 5 ký tự" value="{{$vc->vc_ten}}">
                                </div>
                                 <div class="form-group">
                                    <label for="exampleInputEmail1">Chi phí</label>
                                    <input type="text" name="vc_chiphi" class="form-control money" id="vcchiphi" placeholder="Chi phí vận chuyển" value="{{$vc->vc_chiphi}}" >
                                    <div id="chiphi"></div>
                                </div>
                                 <div class="form-group">
                                    <label for="exampleInputEmail1">Thông tin </label>
                                    <input type="text" name="vc_thongtin" class="form-control" id="exampleInputEmail1" placeholder="Thông tin" data-validation="length" data-validation-length="min5"  data-validation-error-msg="Làm ơn điền ít nhất 5 ký tự" value="{{$vc->vc_thongtin}}">
                                </div>
                               
                          
                                 <button type="submit" name="suavc" class="btn btn-info">Lưu</button>
