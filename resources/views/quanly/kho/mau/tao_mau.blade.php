                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                <form role="form" action="{{URL::to('/banhang/tao-mau')}}" method="post">
                                    {{ csrf_field() }}
                                   
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Tên màu (VD: đỏ, cam, vàng,...)</label>
                                    <input type="text" name="mau_tenht" class="form-control" id="mauht" placeholder="Tên màu" data-validation="length" data-validation-length="min2"  data-validation-error-msg="Làm ơn điền ít nhất 2 ký tự">
                                    <input type="hidden" name="mau_ten" id="mauten"/>
                                </div>
                              
                          <div class="form-group">
                                     <label for="exampleInputEmail1">Giá trị màu sắc</label>
                                        <input    name="mau_giatri" class="form-control basic" id="color1" type="text" value="" data-validation="length" data-validation-length="min1"  data-validation-error-msg="Làm ơn điền giá trị màu"/>
                                     
                                      
                             
                                  
                                </div>
                                 <button type="submit" name="taomau" class="btn btn-info">Lưu</button>
