...
<div class="row">
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                <form role="form" action="{{URL::to('/banhang/sua-mau/'.$mau->mau_id)}}" method="post">
                                    {{ csrf_field() }}
                                   <?php
                                   $mau_ht=$mau->mau_ten;
                                     $mau_ht1=strpos($mau_ht," " )+1;
                                    $mau_ht2=substr($mau_ht,$mau_ht1,strlen($mau_ht));
                                   ?>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Tên màu (VD: đỏ, cam, vàng,...)</label>
                                    <input type="text" name="mau_tenht" class="form-control" id="mauht" value="{{$mau_ht2}}" placeholder="Tên màu" data-validation="length" data-validation-length="min2"  data-validation-error-msg="Làm ơn điền ít nhất 2 ký tự">
                                    <input type="hidden" name="mau_ten" id="mauten" value="{{$mau->mau_ten}}">
                                </div>
                               <div class="form-group">
                                     <label for="exampleInputEmail1">Giá trị màu sắc</label>
                                        <input   name="mau_giatri" class="form-control basic" id="color1" type="text" value="{{$mau->mau_giatri}}" data-validation="length" data-validation-length="min1"  data-validation-error-msg="Làm ơn điền giá trị màu"/>       
                                </div>
                          
                                 <button type="submit" name="suamau" class="btn btn-info">Lưu</button>
                          <a type="button" name="taomau" class="btn btn-success" href="{{ URL::to('banhang/danhsach-mau') }}">Trở về</a><br>
  ...
  $(document).ready(function(){
    $(document).on('change', '#mauht', function(){
        var mau=$(this).val();
        $('#mauten').val('màu '+mau);
    });});
</script>
