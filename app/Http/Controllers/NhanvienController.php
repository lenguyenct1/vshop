...
class NhanvienController extends Controller
{
       ...
       public function getdanhsach_nv(){
        $nv=User::all();
        return view('quanly.nhanvien.danhsach_nv',['nv'=>$nv]);
    }
     public function gettao_nv(){
      
        return view('quanly.nhanvien.tao_nv');
    }
     ...
     return redirect('banhang/danhsach-nv')->with('thongbao','Bạn đã xóa nhân viên không thành công (do nhân viên có ràng buộc dữ liệu)');
}
      ...
      public function getsua_nv($nv_id){
        ...
        $nv=User::find($nv_id);
        return view('quanly.nhanvien.sua_nv',['nv'=>$nv]);
    }
     public function postsua_nv(Request $request,$id){
      ...
      return redirect('banhang/danhsach-nv')->with('thongbao','Sửa thông tin nhân viên không thành công');
}
      ...
      return redirect('banhang/danhsach-nv')->with('thongbao','Thêm nhân viên không thành công');
}
