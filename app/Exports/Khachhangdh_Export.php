...
class Khachhangdh_Export implements FromView, ShouldAutoSize,WithEvents 
{
    protected $data;
    protected $ddh;
    protected $kh;
    ...
    */
    public function __construct($ddh,$kh,$date) {
        //$this->data = $data;
        $this->ddh = $ddh;
        $this->kh = $kh;
        $this->date = $date;
    ...
    public function view(): View
    {
       ...
       // dd($kh);
       // dd($a);
        return view('quanly.banhang.khachhang.excel_kh', [
            //'data' => $data,
            'ddh' => $ddh,
            'kh' => $kh,
            'date' => $date,
