...
class Dsspton_Export implements FromView , ShouldAutoSize,WithEvents
{
    protected $data;
    protected  $date;
    protected  $tinhtrang;
    ...
    */
    public function __construct($date,$data,$tinhtrang,$search) {
        //$this->data = $data;
    ...
    public function view(): View
    {
       ...
       // dd($kh);
       // dd($a);
        return view('quanly.kho.sanpham.excel_ton_sp', [
            //'data' => $data,
            'tinhtrang' => $tinhtrang,
            'date' => $date,
            'data' => $data,
